const STORAGE_KEY_PREFIX = "lie-unnie-survey-submission:";
const LEGACY_STORAGE_KEY_PREFIX = "tripagent-survey-submission:";
...
export function readSurveySubmission(submissionId) {
  ...
  const rawValue =
    ...
    window.localStorage.getItem(`${LEGACY_STORAGE_KEY_PREFIX}${submissionId}`);
