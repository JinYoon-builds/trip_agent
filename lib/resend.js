...
function getPaymentCompletedCustomerCopy(language) {
  ...
  if (normalizedLanguage === "en") {
    return {
      subject: "[刘Unnie] Your payment is complete",
...
export async function sendPaymentCompletedNotifications({ submission }) {
  ...
  const requests = [
    ...
    },
    {
      from: emailFrom,
      to: notificationEmails,
      subject: `[刘Unnie] Payment completed / ${amountLabel} / ${applicantName}`,
      text: [
        "A 刘Unnie payment has been completed.",
        "",
